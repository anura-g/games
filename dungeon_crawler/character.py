...
class Character():
    def __init__(self, x, y, health, mob_animations, char_type, boss, size):
        ...
        self.update_time = pygame.time.get_ticks() # how much time has passed since frame was last updated 
        self.running = False # start with idle 
        self.health = health 
        self.alive = True
        self.hit = False 
    ...
    def ai(self, player, obstacle_tiles, screen_scroll, fireball_image):
        ...
        # create line of sight from the enemy to the player 
